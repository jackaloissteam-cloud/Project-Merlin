...
"""
    ...
    return build_hero(state, settings), build_aircraft_passport(), target_summary(), details, build_map(), build_events(), event_id
...
with gr.Blocks(title="Project Merlin – Frances Dell") as demo:
    ...
    outputs = [hero_html, passport_html, target_md, status_md, map_plot, event_table, last_event]
